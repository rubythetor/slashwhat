...
import { COLUMN_DEFS, COL_DEF_MAP, HAS_SETTINGS, COLUMN_TOOLTIPS } from './table-render-constants.js';

// Re-export so callers (splitter-view.js, tree-rows.js) don't need separate imports.
export { computeJoinBars, escapeHtml };
// Re-export table metadata so existing import sites keep a stable API.
export { COLUMN_DEFS, COL_DEF_MAP };
