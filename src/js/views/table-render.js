...
// Re-export so splitter-view.js doesn't need a separate import.
export { computeJoinBars };
...
// Prevent XSS when inserting user-editable names into innerHTML templates.
